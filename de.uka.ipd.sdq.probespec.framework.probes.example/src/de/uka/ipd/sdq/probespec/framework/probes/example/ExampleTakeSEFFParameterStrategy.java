...
public class ExampleTakeSEFFParameterStrategy implements IProbeStrategy {
	...
	@Override
	public BasicMeasurement<?, Dimensionless> takeSample(String probeId, Object... o) {
		...
		BasicMeasurement<?, Dimensionless> sample = null;
		if (parameter.getValue() instanceof Double) {
			...
			sample = new BasicMeasurement<Double, Dimensionless>(value, probeId,
			...
			sample = new BasicMeasurement<Float, Dimensionless>(value, probeId,
					ProbeType.SEFF_PARAMETER);
			...
			sample = new BasicMeasurement<Integer, Dimensionless>(value, probeId,
					ProbeType.SEFF_PARAMETER);
			...
			sample = new BasicMeasurement<Long, Dimensionless>(value, probeId,
					ProbeType.SEFF_PARAMETER);
		} else {
