...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.probespec.Probe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProbeItemProvider
	...
	protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Probe_name_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Probe_name_feature", "_UI_Probe_type"),
                 probespecPackage.Literals.PROBE__NAME,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addTransientPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Probe_transient_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Probe_transient_feature", "_UI_Probe_type"),
                 probespecPackage.Literals.PROBE__TRANSIENT,
                 true,
                 false,
                 false,
	...
	public String getText(Object object) {
        String label = ((Probe<?>)object).getName();
