 ...
 * 
 * A garbage collector for the {@link Blackboard}. It cleans up obsolete measurements stored at the
 * blackboard.
 * <p>
 ...
 * 
 */
public abstract class AbstractRegionBasedGarbageCollector<T extends MeasurementContext> implements
        RegionBasedGarbageCollector<T> {

    public static Logger logger = Logger.getLogger(AbstractRegionBasedGarbageCollector.class);
     ...
     */
    public AbstractRegionBasedGarbageCollector(Blackboard<?> blackboard) {
