...
//
//    private BiMap<Object, PMeasurableEntity> entityMap = HashBiMap.create();
...
//                Object e = entityMap.inverse().get(pe);
...
//        Set<Object> entities = probeRegistry.getEntities();
//        for (Object e : entities) {
//            PMeasurableEntity pe = ProbespecFactory.eINSTANCE.createPMeasurableEntity()();
//            pe.setId(e.getObjectId());
//            pe.setName(e.getObjectName());
...
//    }
//
//    private Set<PMeasuringPoint> createMeasuringPointsForEntity(Object entity) {
...
//            p.setId(entity.getObjectId() + "." + o.toString()); // TODO
...
//    }
//
//    private Set<PProbe> createProbes(Object entity, Object measuringPoint) {
...
//
//        public KeyPair(Object entity, Object measuringPoint) {
//            this.entity = entity;
