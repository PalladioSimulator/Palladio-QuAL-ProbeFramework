...
\title[ProbeFramework]{ProbeFramework}
...
\begin{frame}
	...
	\item Current situation
		...
		\end{itemize}
	\pause
	\item SimuCom with ProbeFramework
		\begin{itemize}
...
\subsection{ProbeFramework}
\begin{frame}
\frametitle{ProbeFramework}
\begin{itemize}
...
\item Framework
	...
	\item Works with arbitrary persistence framework
		...
		\end{itemize}
	\item Independent of ProbeFramework $\Rightarrow$ reusable!
	\end{itemize}
%\item Implements Pipes-and-Filters architecture style
%\item Allows filtering
%\item ProbeFramework uses Pipes-and-Filters
%\item Pipes-and-Filters independent of ProbeFramework %Thus reusable
\end{itemize}
\end{frame}
...
\item All documents resides in the SVN:\\{\tiny /code/Palladio.ProbeFramework/trunk/org.palladiosimulator.probeframework/doc}
\end{itemize}
\end{frame}
