...
public class StateCalculator extends UnaryCalculator {
     ...
     */
    public StateCalculator(final ProbeSpecContext ctx, final String metricName, final String metricDescription, final Probe probe) {
        super(ctx, Calculator.createMetricSetDescription(metricName, metricDescription, Arrays.asList(MetricDescriptionConstants.CPU_STATE_METRIC)), probe);
    }
